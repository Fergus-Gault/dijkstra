...
class Node(pygame.sprite.Sprite):
    def __init__(self, posx, posy, rad, label):
        pygame.sprite.Sprite.__init__(self, display.all_nodes) # Initialises Sprite object and adds to all_nodes
        self.image = pygame.Surface((display.CIRC_RAD*2,display.CIRC_RAD*2))
    ...
    def _remove_node(self):
        display.all_nodes.remove(self) # Removes node
    ...
    def _draw_node(self):
        ...
        display.SCREEN.blit(self.image, self.rect.topleft)
